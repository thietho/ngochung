function goPage(page, filter) {
    window.location.href = "?route=module/news/" + filter + "&page=" + page;
}
...
function updateList() {
    ...
    var $url = "index.php?route=module/news/updatePosition";
...
function confirmDeleteList() {
    showSimpleModal("<?php echo $lang_text_delete_data ?>", "<?php echo $lang_text_confirm_delete ?>", "news_delete()", "<?php echo $lang_text_cancel?>", "<?php echo $lang_text_delete ?>");
}
...
function news_delete() {
    ...
    var url = "?route=module/news/deleteList";
    $.post(url, $('#formlist').serialize(), function ($data) {
        var $response = JSON.parse($data);
        var $errors = $response['errors'];
        if($response['status'] == 'failed') {
...
function sort(object, $orderby) {
    ...
    window.location.href = "?route=module/news/&sitemapid="+ $sitemapid + "&orderby=" + $orderby + "&sort=" + $sort + "&page=" + $page;
}
...
function searchForm() {
    ...
    var url = "?route=module/news&sitemapid=" + $sitemapid;
