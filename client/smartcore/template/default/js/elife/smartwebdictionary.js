function confirmDeleteList() {
    showSimpleModal("<?php echo $lang_text_delete_data ?>", "<?php echo $lang_text_confirm_delete ?>", "smartwebdictionaryDelete()", "<?php echo $lang_text_cancel?>", "<?php echo $lang_text_delete ?>");
}

function smartwebdictionaryDelete() {
    closeSimpleModal();
    ...
    var url = "?route=elife/smartwebdictionary/deleteList";
