function confirmDeleteList() {
    showSimpleModal("<?php echo $lang_text_delete_data ?>", "<?php echo $lang_text_confirm_delete ?>", "dictionaryDelete()", "<?php echo $lang_text_cancel?>", "<?php echo $lang_text_delete ?>");
}
...
function dictionaryDelete() {
    ...
    var url = "?route=elife/dictionary/deleteList";
