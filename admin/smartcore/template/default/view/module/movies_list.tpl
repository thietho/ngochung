        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="pull-left margin-bottom-20">
                    <button onclick="window.location.href='<?php echo HTTP_WEB ?>?route=module/movies/insert'" type="button" class="btn btn-default btn-bg btn-success"><span class="fa fa-plus"></span> Add movies</button>
                </div>
                <?php } ?>
...
<script type="application/javascript">
    function Movies()
    {
        ...
        {
            showLoading();
            $.get("?route=module/movies/loadData", $('#frmMoviesSearch').serialize(), function(html){
                endLoading();
        ...
        {
            $.get('?route=module/movies/delete&id=' + this.id,function(data){
                if(data == 'true')
                {
