    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td><?php echo $product['sitemapname'] ?></td>
                ...
                <td class="text-center">
                    ...
                    <button onclick="window.location.href='<?php echo HTTP_WEB ?>?route=module/product/update&id=<?php echo $product[id] ?>'" type="button" class="btn btn-sm btn-default btn-icon btn-edit btn-info margin-0 margin-right-5"><span class="fa fa-edit"></span></button>
                    <?php } ?>
                </td>
            </tr>
            <?php } } ?>
...
<div class="mobile-show">
    ...
    <div class="itemrow">
        ...
        <div class="pull-right">
            ...
            <button onclick="window.location.href='<?php echo HTTP_WEB ?>?route=module/product/update&id=<?php echo $product[id] ?>'" type="button" class="btn btn-default btn-icon btn-edit btn-info margin-0 margin-right-5"><span class="fa fa-edit"></span></button>
            <?php } ?>
        </div>
        <div class="clear-mobile"></div>
    </div>
