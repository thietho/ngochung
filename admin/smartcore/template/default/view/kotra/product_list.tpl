        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="pull-left margin-bottom-20">
                    <button onclick="window.location.href='<?php echo HTTP_WEB ?>?route=kotra/product/insert'" type="button" class="btn btn-default btn-bg btn-success"><span class="fa fa-plus"></span> Add product</button>
                </div>
                <?php } ?>
...
<script type="application/javascript">
    function Product()
    {
        ...
        {
            showLoading();
            $.get("?route=kotra/product/loadData", $('#frmProductSearch').serialize(), function(html){
                endLoading();
        ...
        {
            $.get('?route=kotra/product/delete&id=' + this.id,function(data){
                if(data == 'true')
                {
