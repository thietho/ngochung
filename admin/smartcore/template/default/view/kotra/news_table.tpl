        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <button onclick="window.location.href='<?php echo HTTP_WEB ?>?route=kotra/news/update&id=<?php echo $news[id] ?>'" type="button" class="btn btn-sm btn-default btn-icon btn-edit btn-info margin-0 margin-right-5"><span class="fa fa-edit"></span></button>
                    <?php } ?>
                </td>
            </tr>
            <?php } } ?>
...
<div class="mobile-show">
    ...
    <div class="itemrow">
        ...
        <div class="pull-right">
            ...
            <button onclick="window.location.href='<?php echo HTTP_WEB ?>?route=kotra/news/update&id=<?php echo $news[id] ?>'" type="button" class="btn btn-default btn-icon btn-edit btn-info margin-0 margin-right-5"><span class="fa fa-edit"></span></button>
            <?php } ?>
        </div>
        <div class="clear-mobile"></div>
    </div>
