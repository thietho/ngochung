        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 margin-top-30">
                <div class="text-center">
                    ...
                    <button onclick="window.location.href='<?php echo HTTP_WEB ?>?route=kotra/product'" type="button" class="btn btn-sm btn-default btn-bg">Cancel</button>
                </div>
            </div>
        </div>
...
$(document).ready(function(){
    ...
    <?php if($_GET['type'] != 'popup'){ ?>
        $('#btnSaveProduct').click(function(){
            ...
            $.post("?route=kotra/product/save",$('#frmProduct').serialize(),function(data){
                endLoading();
                ...
                {
                    toastr.options.onHidden = function() { window.location = '?route=kotra/product'};
